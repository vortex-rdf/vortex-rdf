...
| [docs/arrow.md](docs/arrow.md) | the Arrow interface: quad batches per encoding, the dictionary export, the Python PyCapsule and JavaScript zero-copy view surfaces |
