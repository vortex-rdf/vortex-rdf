...
| [`FileServePlan::bound`](../core/src/store/indexes/serve.rs#L459) | the plan's bound projection and filter | the first read through the plan | two expression trees | the view |
...
| Concern | Where |
|---|---|
| The resident forms: canonical base, compressed components, encoded adoption | [`core/src/store/array.rs`](../core/src/store/array.rs), [`mod.rs`](../core/src/store/mod.rs) ([`resident_built_parts`](../core/src/store/mod.rs#L165), [`from_parts`](../core/src/store/mod.rs#L235)) |
